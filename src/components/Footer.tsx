...
const Footer = () => {
  ...
  return (
    <footer id="vote" className="bg-foreground text-primary-foreground" ref={ref}>
        ...
        <div className="section-container">
          ...
          >
            ...
            >
              <img
                src={bottomCta}
                alt="হাঁস মার্কা হবে কালিহাতির মার্কা"
            ...
            >
              <a
                href="#hero"
                className="inline-flex items-center gap-3 bg-accent hover:bg-accent/90 text-accent-foreground font-bold px-8 py-4 rounded-full text-lg transition-all hover:scale-105"
              >
