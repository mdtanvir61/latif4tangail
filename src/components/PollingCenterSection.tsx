...
const pollingCenters = [
  ...
  {
    area: "কালিহাতী পৌরসভা",
    type: "pourashava",
    centers: [
      "কালিহাতী পাইলট সরকারি উচ্চ বিদ্যালয়",
      "কালিহাতী সরকারি বালিকা উচ্চ বিদ্যালয়",
      "কালিহাতী সদর প্রাথমিক বিদ্যালয়",
      "কালিহাতী ডিগ্রি কলেজ",
    ],
  },
  {
    area: "বল্লা ইউনিয়ন",
      ...
      <div className="section-container" ref={ref}>
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            টাঙ্গাইল-৪ (কালিহাতী) আসনের ১১৪টি ভোট কেন্দ্র
          </p>
